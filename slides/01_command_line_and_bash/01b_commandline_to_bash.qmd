...
```{bash}
cd /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir
wget --quiet https://raw.githubusercontent.com/rreggiar/ucsc_scbc_2022/master/data/talking.txt
mv /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/talking.txt /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data

wget --quiet https://raw.githubusercontent.com/rreggiar/ucsc_scbc_2022/master/data/gene_panel_database.fa
mv gene_panel_database.fa /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data
...
```{bash, echo=F, eval=T, error=F}
rm /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.fa
for gene in KRAS EGFR TP53; do grep $gene /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data/gene_panel_database.fa >> /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.fa; done
cat /Users/vikas/Documents/UCSC/teaching/ucsc_scbc_2022/slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.fa
```
...
cat ../../slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.fa
```
...
-   Your `final_gene_panel.csv` should look something like with **rows** on each line and columns separated by `,`:
    ...
    ```{bash}
    cat ../../slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.csv
    ```
...
```{bash}
cut -d',' -f1,4,5 ../..//slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.csv
```
...
```{bash}
echo 'gene,chromosome,start,stop,strand' > ../..//slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.csv & for gene in KRAS EGFR TP53; do grep $gene ../..//slides/01_command_line_and_bash/BSCC_2023_dir/data/gene_panel_database.fa| cut -d'>' -f2 >> ../..//slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.csv; done
cat ../..//slides/01_command_line_and_bash/BSCC_2023_dir/data/final_gene_panel.csv
```
